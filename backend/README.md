...
## Project Structure
    ...
    ├── wispy_wildflower_28991  # Django project configurations
...
1. Clone this repo and `cd wispy_wildflower_28991`
...
2. Clone this repo and `cd wispy_wildflower_28991`
